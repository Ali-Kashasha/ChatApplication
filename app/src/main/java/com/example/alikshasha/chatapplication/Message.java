        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(list_message.get(position).getBody().contains("fileuploadedtoyourfiendthismessagenotify")) {
                    ...
                    Toast.makeText(Message.this, R.string.donwloading_file, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void start_upload(String path)
    {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                Toast.makeText(Message.this, R.string.fail_upload, Toast.LENGTH_SHORT).show();
            }
    ...
    private void download_file(final String file) {
        ...
        storageRef.child(realtime_database.detemined_node(next_phone)+"/"+file.trim())
            ...
            public void onSuccess(Uri uri) {
                Toast.makeText(Message.this, R.string.downloaded, Toast.LENGTH_SHORT).show();
                Log.d("thisfile_todownload"+file,"") ;
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception exception) {
                Toast.makeText(Message.this, R.string.cant_down, Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
